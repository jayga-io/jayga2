...
class ListingController extends Controller
{
    ...
    public function filter(Request $request){
        $filtered_listing = QueryBuilder::for(Listing::class)->where('isApproved', true)->allowedFilters(['guest_num', 'bed_num', 'district', 'town', 'allow_short_stay', 'listing_type'])->with('images')->with('describes')->get();
