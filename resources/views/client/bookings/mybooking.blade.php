        ...
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Active Bookings</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Past Bookings</button>
                </li>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 border-right">
                                            ...
                                            <button class="btn btn-success my-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                                                id="refund_button" listing-id="{{$item->listing_id}}" lister-id="{{$item->lister_id}}"
                                                booking-id="{{$item->booking_id}}" refund-amount="{{$item->pay_amount}}"
                                                onclick="refund_calc(this)">Claim Refund</button>
                                            @endif
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            <form action="{{ route('claimrefund') }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" value="{{ Session::get('user') }}" name="user_id">
                                                    ...
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        ...
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link" id="bkash-tab" data-bs-toggle="tab"
                                                                data-bs-target="#bkash-tab-pane" type="button" role="tab" aria-controls="bkash-tab-pane"
                                                                aria-selected="false">Bkash</button>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active" id="bank-tab-pane" role="tabpanel"
                                                        ...
                                                        <div class="tab-pane fade" id="bkash-tab-pane" role="tabpanel" aria-labelledby="bkash-tab"
                                                            tabindex="0">
                                                            <div class="my-2">
