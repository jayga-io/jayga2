                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 border-right">
                                ...
                                <div>
                                    ...
                                    <p>Checkin : <span>{{$item->date_enter}}</span> | <span>Checkout: <span>{{$item->date_exit}}</span></span></p>
                                </div>
                                <a class="btn btn-success my-3" href="/client/single-listing/{{$item->listings->listing_id}}">Review Listing</a>
                            </div>
                            <div class="col-md-3 d-flex my-5">
                                <div class="mx-3" >
                                    <p>{{$item->listings->full_day_price_set_by_user}} * {{$item->listings->days_stayed}} Nights</p>
