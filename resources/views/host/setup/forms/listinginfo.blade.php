...
@section('content')
    <div class="left-side">
        <div class="left-heading">
            <a href="{{ route('userdash') }}"><img src="{{ asset('assets/img/logo/jayga-01.png') }}" alt=""
        ...
        <div class="steps-content">
            ...
            <p class="step-number-content d-none">Whether it’s a room for stay or an experience to offer, Jayga has got you
                covered</p>
    ...
    <div class="right-side">
        ...
        <div class="main active">
            <small><img src="{{ asset('assets/img/logo/jayga-appicon1.png') }}" style="width: 50px; height: 50px;"
                    alt="" srcset=""></small>
            <div class="text">
                ...
                <div class="input-text">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="input-group w-auto justify-content-end align-items-center">
                                    ...
                                    <input type="number" step="1" max="10" value="1" name="guest_num"
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="input-group w-auto justify-content-end align-items-center">
                                    <input type="button" value="-"
                                        class="button-minus border rounded-circle  icon-shape icon-sm mx-1 "
                                        data-field="bed_num">
                                    <input type="number" step="1" max="10" value="1" name="bed_num"
                                        class="quantity-field border-0 text-center w-25">
                                    <input type="button" value="+"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="input-group w-auto justify-content-end align-items-center">
                                    ...
                                    <input type="number" step="1" max="10" value="1" name="bathroom_num"
                                        class="quantity-field border-0 text-center w-25">
                                    <input type="button" value="+"
                                        class="button-plus border rounded-circle icon-shape icon-sm lh-0"
                                        data-field="bathroom_num">
                        ...
                        <div class="col-md-12 ">
                            <div class="input-text">
                                ...
                                <div class="input-div">
                                    ...
                                    <input type="checkbox" name="allow_short_stay" value="1" id="short_stay_click"
                                        onchange="dohide(this)">
                        ...
                        <div class="col-md-12" id="short_stay_def">
                            <div class="input-text">
                                <p>
                                    By agreeing to host Short Stays on Jayga you are agreeing to host multiple stays in 1
                                    day, potentially earning more per day.
                                </p>
